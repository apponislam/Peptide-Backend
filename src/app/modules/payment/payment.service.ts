...
export class StripeService {
    ...
    // Update the method signature - remove shippingInfo
    ...
    private async createOrderFromSession(session: EnhancedStripeSession, userId: string, shippingInfo: any, shippingCost: number, storeCreditUsed: number, itemsFromMetadata: any[] = []) {
        try {
            ...
            console.log("Full session:", JSON.stringify(sessionDetails, null, 2));
            ...
            // Get shipping info directly from session - FIXED
            ...
            console.log("✅ Final Shipping info from Stripe:", orderShippingInfo);
