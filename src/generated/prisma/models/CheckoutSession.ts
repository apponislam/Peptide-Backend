...
export interface CheckoutSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    groupBy<
        ...
        OrderByArg extends Prisma.True extends HasSelectOrTake ? { orderBy: CheckoutSessionGroupByArgs["orderBy"] } : { orderBy?: CheckoutSessionGroupByArgs["orderBy"] },
    ...
    ): {} extends InputErrors ? GetCheckoutSessionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
