...
export declare const adminControllers: {
    ...
    getTopSellingProducts: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
    getReferralPerformance: (req: Request, res: Response, next: import("express").NextFunction) => Promise<void>;
